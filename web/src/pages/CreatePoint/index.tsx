...
const CreatePoint = () => {
    ...
    function handlSelectedDistrict(event: ChangeEvent<HTMLSelectElement>)
    {
                ...
                <fieldset>
                    ...
                    <div className="field-group">
                        <div className="field">
                            ...
                            <select name="district" id="district" value={selectedDistrict} onChange={handlSelectedDistrict}>
